...
![Analytics](https://img.shields.io/badge/Analytics-Business%20Focused-green)
![Project](https://img.shields.io/badge/Project-Real%20World-orange)
...
This project demonstrates **end-to-end data analysis using SQL** on an e-commerce dataset.
It focuses on deriving **actionable business insights** using advanced SQL techniques.
